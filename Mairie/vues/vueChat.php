...
<h1 class="text-info d-flex align-items-center justify-content-center">Bienvenu sur le chat du site!</h1>
<h2 class="text-info d-flex align-items-center justify-content-center">Discutez avec les autres utilisateurs en toute liberté</h2>
<br>
<br>
<div class="jumbotron bg-info">
    <?php
    if(isset($tabTousLesMessagesChat)){
        foreach($tabTousLesMessagesChat  as $m){
            echo "<h3><u>".$m->getAuteur()."</u> a dit : ".$m->getMessage()."</h3>";
        }
    }
    else echo 'Aucun message, soyez le premier à en mettre un !';
    ?>
</div>
...
<footer>
    <div class="d-flex align-items-center justify-content-center">
        <div class="jumbotron bg-info">
            <h3>Communiquez avec les autres utilisateurs : </h3>
            <form  method="post" action="" class="form-example">
                <div>
                    ...
                    if(isset($pseudocommentaireS)){
                        ...
                        echo "<input name='Pseudo' type='text' size='20' required>";
                    }?>

                </div>
                <div>
                    <label for="Message">Message :  </label>
                    <input name="Message" type="text" size="20" required>
                </div>
                <div>
                    <input class="btn btn-dark" type="submit" name='action' value="AjouterUnMessage">
                </div>
            </form>
        </div>
    </div>
