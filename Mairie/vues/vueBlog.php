...
<div class="d-flex align-items-center justify-content-center">
    <div class="jumbotron bg-info">
        ...
        if(isset($nbrmessages))
            echo "Il y a actuellement ".$nbrmessages." commentaire(s) au total sur le blog.";
        else{
            echo "Il y a aucun commentaire sur le blog :(";
        }
        echo"<br><br>";
        ...
        <div class="d-flex align-items-center justify-content-center">
            <form  method="post" action="" class="form-example">
                ...
                <div>
                    <input type="submit" name='action' value="RechercherArticlesParDate">
                </div>
            </form>
        </div>
        ...
        <br>
                    ...
                    <?php
                    if(!empty($tabNews) && isset($tabNews)){
        ...
        <center>
            ...
            for($i=1;$i<=$pagesTotales;$i++) {
                if($i == $pageCourante) {
                    ...
                    echo '<a class="text-dark" href=?action=OuvrirLeBlog&page='.$i.'>'.$i.'</a> ';
                }
            }
            ?>
        </center>
